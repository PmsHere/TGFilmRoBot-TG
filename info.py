...
API_ID = environ.get('API_ID', '1872632')
API_HASH = environ.get('API_HASH', '4312472d5d2f1473e4295ddd4a497613')
BOT_TOKEN = environ.get('BOT_TOKEN', '5353888647:AAEeteJIH8ylNswSF0AmEerws9jwCagb0Q0')
USER_SESSION = environ.get('USER_SESSION', 'BQAckvgAEE4wojtxcmtGeHmkBG14n4ymuVHdxSnbk33OEAP2TIJIBRpdRpRtmejipMDpFK-7RET3M_5w9dDtWy-H4RLCfm3C-VupE1VLQ3YWhwELWvZlFDA_7CZ-hXIx0IjDdLqNW1VZR-gmF-UjAvTtLiT6Z9n5-Tca9EkuUlGT2CGp0PA1oZMncv-93VLeYiOK4F1fmDq_G8afmotNz1R8QZbhnAu4PsALcmZcFttsuiTH3bYL6jLh-gkeZJ4B7PaUFedJh0L7QKV-iY8VU-uZ7bZ9Ytg_DbXrIt_pDxLWM2t59e7WuxTeQ_efOYarlFhdf1TY2qDu4bq__If4TgcCpkg3RwAAAABctJvFAA')
# Bot settings
...
ADMINS = [
    ...
    for admin in environ.get('ADMINS', '1893684647 1555340229').split()
]
CHANNELS = [
